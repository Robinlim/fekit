...
(function() {
  var CSSModule, JSModule, MODULE_COMPILE_TYPE, MODULE_CONTENT_TYPE, Module, ModuleConfig, ModulePath, md5, parser, syspath, utils,
  ...
  Module = (function() {
    function Module(uri) {
      ...
      this.guid = checksum || md5(this.source);
    }
    ...
    Module.prototype._process = function(path, cb) {
      ...
      if (plugin) {
        return plugin.process(this.source, path, this, function(err, result) {
          if (err) {
  ...
  Module.parse = function(path, parentModule, rootModule) {
    var m, uri;
    if (parentModule) {
